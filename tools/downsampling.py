...
if __name__ == "__main__":
    input_folder = "./data/MetalSet/mask/1nm/images"  # Replace with your input folder path
    output_folder = "./data/MetalSet/mask/7nm/images"  # Replace with your output folder path
